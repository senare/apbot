/*
 * PrivateChannelInvitePacket.java
 *
 * Created on July 11, 2010, 10:30 PM
 *************************************************************************
...
public class PrivateChannelInvitePacket extends Fact {

    public static final short TYPE = 50;

    private int groupId;

    public PrivateChannelInvitePacket() {
        super(TYPE);
    }

    public PrivateChannelInvitePacket(int groupId) {
        super(TYPE);
