...
public class LoginRequestPacket extends Packet {
	 ...
	 *            {@link ao.protocol.auth.LoginKeyGenerator#generateLoginKey(String, String, String)}
	 * @throws NullPointerException
	 *             userName or key is null
	 *
	 * @see ao.protocol.auth.LoginKeyGenerator#generateLoginKey(String, String,
	 *      String)
	 */
	public LoginRequestPacket(int version, String accountName, String key) {
		if (accountName == null) {
			throw new NullPointerException("No account name was passed.");
		}
		if (key == null) {
			throw new NullPointerException("No key was passed.");
		}
		...
		PacketSerializer serializer = new PacketSerializer(8 + m_accountname.length() + m_key.length());
	...
	public LoginRequestPacket(byte[] data) throws MalformedPacketException {
		...
		try {
			...
			throw new MalformedPacketException("The packet could not be parsed.", e, new UnparsablePacket(TYPE, data, Direction.TO_SERVER));
		} // end catch
	} // end LoginRequestPacket()
