...
import ao.protocol.packets.ExtendedMessage;
...
public class ChannelMessagePacket extends Fact {
    ...
    /**
     * Creates a new instance of ChannelMessagePacket (outgoing only)
     *
     * @param groupID
    ...
    public ChannelMessagePacket(byte[] groupID, int characterID, String msg, String str, Direction d) {
        ...
        PacketSerializer serializer = new PacketSerializer(4 + 5 + 4 + m_msg.length() + m_str.length());
    ...
    public ChannelMessagePacket(byte[] data, MMDBDatabase db, Direction d) throws MalformedPacketException {
        ...
        try {
            ...
            throw new MalformedPacketException("The packet could not be parsed.", e, new UnparsablePacket(TYPE, data, d));
        } // end catch
    } // end ChannelMessagePacket()
